...
export class ChangePasswordUseCase {
  ...
  async execute(dto: ChangePasswordInput): Promise<void> {
    const traceId = this.cls.get<string>('traceId');
    this.logger.info('ChangePasswordUseCase start', { traceId });
    ...
    this.eventEmitter.emit(
      ...
      new PasswordChangedEvent(user.id.value),
    );
    ...
    this.logger.info('ChangePasswordUseCase end', {
      traceId,
