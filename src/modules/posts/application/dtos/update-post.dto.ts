...
export const UpdatePostSchema = z
  .object({
    postTitle: z
      ...
      .max(255)
      .optional()
      .describe('Post title. HTML is stripped server-side (plain text only).'),
    postTitleSlug: z
      .string()
      .max(255)
      .optional()
    ...
    postExcerpt: z
      ...
      .nullable()
      .optional()
      .describe('Short excerpt / description. HTML is stripped server-side.'),
    ...
    metaTitle: z
      ...
      .nullable()
      .optional()
      .describe('SEO meta title. HTML is stripped server-side.'),
    metaDescription: z
      .string()
      .max(500)
      .nullable()
      .optional()
      .describe('SEO meta description. HTML is stripped server-side.'),
    metaKeywords: z
      .string()
      .max(255)
      .nullable()
      .optional()
      .describe('Comma-separated keywords. HTML is stripped server-side.'),
