...
4. Read the required guidance in this order:
   ...
   3. `.windsurf/skills/BACKEND-NEST-PATTERNS/SKILL.md` — findOrFail, singleton guard, repository return rules (applies to SIMPLE + DEFAULT)
   4. `.windsurf/skills/ARCHITECTURE-DECISION-GUIDE.md` — to decide which architecture to use
   5. Then read the selected architecture skill:
      - `.windsurf/skills/ARCHITECTURE-SIMPLE/SKILL.md` for simple lookups/configs
      - `.windsurf/skills/ARCHITECTURE-DEFAULT/SKILL.md` for CRUDs with business logic
      - `.windsurf/skills/ARCHITECTURE-ENTERPRISE/SKILL.md` for complex bounded contexts
